...
import { campusFetch } from "./useEstablishment";
import {
  Avatar,
  Badge,
  Card,
  ...
  return (
    <>
      ...
      <div className={styles.kpis}>
        <Kpi
          ...
          link={{
            ...
            href: "/establishment/student/schedule",
          }}
        />
        <Kpi
          icon="edit"
          ...
          link={{ label: "Voir mes travaux", href: "/establishment/student/assignments" }}
        />
        <Kpi
          icon="clipboard"
          tone="violet"
      ...
      <div className={styles.grid3}>
        ...
        <Card
          title="Mes travaux"
          link={{ label: "Voir tout", href: "/establishment/student/assignments" }}
        >
        ...
        <Card
          ...
          link={{ label: "Voir tout", href: "/establishment/student/notifications" }}
        >
  ...
  return (
    <>
      ...
      <div className={styles.kpis}>
        <Kpi
          ...
          link={{
            ...
            href: "/establishment/teacher/schedule",
          }}
        />
        <Kpi
          icon="users"
          ...
          link={{
            ...
            href: "/establishment/teacher/classes",
          }}
        />
        <Kpi
          icon="edit"
      ...
      <div className={styles.grid3wide}>
        ...
        <Card
          title="Mes classes"
          link={{ label: "Voir toutes", href: "/establishment/teacher/classes" }}
        >
            ...
            <>
              {data.toCorrect > 0 ? (
                <Todo
                  icon="edit"
                  tone="red"
                  action={{ label: "›", href: "/establishment/teacher/assignments" }}
                >
      ...
      <div className={styles.grid2}>
        <Card
          ...
          link={{ label: "Voir le suivi", href: "/establishment/teacher/progress" }}
        >
          {data.watch.length === 0 ? (
            <Empty>
        ...
        <Card
          ...
          link={{ label: "Voir tout", href: "/establishment/teacher/resources" }}
        >
    ...
    <>
      ...
      <div className={styles.grid3}>
        <Card
          ...
          link={{ label: "Voir le détail", href: "/establishment/pedagogy/progress" }}
        >
        ...
        <Card
          ...
          link={{ label: "Voir tout", href: "/establishment/pedagogy/documents" }}
        >
      ...
      <div className={styles.grid3}>
              ...
              {data.lowProgressClasses > 0 ? (
                <Todo
                  ...
                  action={{
                    ...
                    href: "/establishment/pedagogy/progress",
                  }}
                >
        ...
        <Card
          ...
          link={{ label: "Voir tout", href: "/establishment/pedagogy/classes" }}
        >
          {data.rooms.length === 0 ? (
    ...
    <>
      ...
      <div className={styles.grid3lead}>
        <Card
          ...
          link={{
            label: "Voir toutes",
            href: "/establishment/admin/admissions",
          }}
        >
        ...
        <Card
          ...
          link={{
            ...
            href: "/establishment/admin/academics",
          }}
        >
      ...
      <div className={styles.grid3}>
        ...
        <Card title="Accès rapides">
          <div className={styles.quickGrid}>
            ...
            <Link
              href="/establishment/admin/schedule"
              className={styles.quickTile}
            >
              <Icon name="calendar" />
              Planifier un cours
            ...
            <Link
              href="/establishment/admin/communication"
              className={styles.quickTile}
            >
              <Icon name="send" />
              Envoyer une annonce
