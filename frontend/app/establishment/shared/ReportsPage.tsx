...
export default function ReportsPage({ role, section }: { role: Extract<RoleSlug, "admin" | "pedagogy">; section: "suivi" | "rapports" }) {
  const { context, data, loading, error, mismatch, reload } = useEstablishmentHome<Report>(role);
