...
export default function FinancePage() {
  ...
  return <Shell role="direction" activeSlug="finances" displayName={context?.displayName} institutionName={context?.institutionName} note={contextError ?? null}>
    <header className={styles.head}><div><small>DIRECTION</small><h1>Abonnement de l’établissement</h1><p>Formule et capacités de votre espace.</p></div><Link href="/campus/direction" className={styles.back}>← Accueil</Link></header>
