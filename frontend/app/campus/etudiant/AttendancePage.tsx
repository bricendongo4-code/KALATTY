...
export default function StudentAttendancePage() {
  ...
  if (mismatch) {
    return <section className={styles.standalone}>Cette page est réservée aux étudiants. <Link href={`/campus/${mismatch.campusRole}`}>Ouvrir mon espace</Link></section>;
  }
  ...
  return <Shell role="etudiant" activeSlug="presences" displayName={context?.displayName} institutionName={context?.institutionName} note={contextError ?? null}>
    <header className={styles.head}>
      ...
      <Link href="/campus/etudiant" className={styles.back}>← Accueil</Link>
    </header>
