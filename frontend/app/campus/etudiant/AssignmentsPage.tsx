...
import { useCampusContext, campusFetch, campusUpload } from "../useCampusHome";
...
export default function AssignmentsPage() {
  const { loading, error, context, mismatch } = useCampusContext("etudiant");
  ...
  return (
    <Shell role="etudiant" activeSlug="travaux" displayName={context?.displayName} institutionName={context?.institutionName} note={error ?? null}>
      {loading ? (
        <p>Chargement...</p>
      ) : (
        <>
